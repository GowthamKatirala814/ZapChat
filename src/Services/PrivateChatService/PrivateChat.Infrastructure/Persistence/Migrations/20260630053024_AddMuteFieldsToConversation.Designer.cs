...
namespace PrivateChat.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260630053024_AddMuteFieldsToConversation")]
    partial class AddMuteFieldsToConversation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PrivateChat.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.Property<DateTime?>("User1MutedUntil")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("User2MutedUntil")
                        .HasColumnType("datetime2");
