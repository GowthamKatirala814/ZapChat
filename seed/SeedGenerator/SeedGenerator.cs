...
{
    // ==========================================================
    // USER DATA — 25 users, email domain @zapcg.com
    // ==========================================================
    static readonly (string FullName, string Email, string Password, string Department, string Branch, string AnonName, bool IsDeleted)[] Users =
    {
        ...
        ("Suresh Babu",      "suresh.babu@zapcg.com",       "Suresh@123",   "Engineering", "Delhi",     "DuskScorpion",    true),  // SOFT DELETED
        ("Nithya Menon",     "nithya.menon@zapcg.com",      "Nithya@123",   "HR",          "Hyderabad", "WildOcelot",      false),
        ("Harish Gupta",     "harish.gupta@zapcg.com",      "Harish@123",   "Sales",       "Bangalore", "FrostManta",      false), // BLOCKED
        ...
        ("Rajesh Mohan",     "rajesh.mohan@zapcg.com",      "Rajesh@123",   "Product",     "Hyderabad", "GhostBison",      true),  // SOFT DELETED
        ...
        ("Mohan Raj",        "mohan.raj@zapcg.com",         "Mohan@123",    "Operations",  "Delhi",     "SilverRhino",     true),  // SOFT DELETED
    };
    ...
    static void Main()
    {
        Console.WriteLine("ZapPulse Seed Generator");
        Console.WriteLine("=======================");
